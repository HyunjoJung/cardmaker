...
public class ExcelImportService : IExcelImportService
{
    ...
    public byte[] CreateTemplate()
    {
        ...
        using (var document = SpreadsheetDocument.Create(stream, SpreadsheetDocumentType.Workbook))
        {
            ...
            var headers = new[] { "Name", "Name (English)", "Company", "Department", "Position", "Position (English)", "Email", "Mobile", "Phone", "Extension", "Fax" };
            ...
            var samples = new[] { "John Doe", "John Doe", "Company Name", "Development", "Team Leader", "Team Leader", "john@company.com", "010-1234-5678", "02-1234-5678", "1234", "02-1234-5679" };
